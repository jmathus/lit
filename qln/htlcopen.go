...
// //
// // DeltaSig:
// // None for now because both positive and negative are used
// // you must be pushing.
// //
// // SigRev:
// // None for now because both positive and negative are used
...
// 	}
//
// 	outMsg := lnutil.NewOpenHTLCDeltaSigMsg(q.Peer(), q.Op, -q.State.Delta, sig, q.State.Data)
// 	nd.OmniOut <- outMsg
//
// 	return nil
// }
...
// func (nd *LitNode) OpenHTLCDeltaSigHandler(msg lnutil.DeltaSigMsg, qc *Qchan) error {
//
// 	var collision bool
...
// 	// TODO.jesus? Check how exactly the channel would store the CurrentHTLC
// 	// if (qc.State.CurrentHTLC.Incoming) {
// 	// 	if incomingDelta < 1 {
...
// func (nd *LitNode) OpenHTLCSendGapSigRev(q *Qchan) error {
...
// 	// total length 165
//
// 	outMsg := lnutil.NewOpenHTLCGapSigRev(q.KeyGen.Step[3]&0x7fffffff, q.Op, sig, *elk, n2ElkPoint)
//
// 	nd.OmniOut <- outMsg
//
// 	return nil
...
// func (nd *LitNode) OpenHTLCSendSigRev(q *Qchan) error {
//
// 	// revoke n-1
// 	elk, err := q.ElkSnd.AtIndex(q.State.StateIdx - 1)
// 	if err != nil {
...
// 	}
//
// 	outMsg := lnutil.NewOpenHTLCSigRev(q.KeyGen.Step[3]&0x7fffffff, q.Op, sig, *elk, n2ElkPoint)
//
// 	nd.OmniOut <- outMsg
// 	return nil
// }
...
// func (nd *LitNode) OpenHTLCGapSigRevHandler(msg lnutil.GapSigRevMsg, q *Qchan) error {
//
...
// func (nd *LitNode) OpenHTLCSigRevHandler(msg lnutil.SigRevMsg, qc *Qchan) error {
//
// 	// load qchan & state from DB
// 	err := nd.ReloadQchanState(qc)
// 	if err != nil {
...
// func (nd *LitNode) OpenHTLCSendREV(q *Qchan) error {
...
// 	}
//
// 	outMsg := lnutil.NewOpenHTLCRevMsg(q.Peer(), q.Op, *elk, n2ElkPoint)
//
// 	nd.OmniOut <- outMsg
//
// 	return err
...
// // Leaves the channel in a clear / rest state.
// func (nd *LitNode) OpenHTLCRevHandler(msg lnutil.RevMsg, qc *Qchan) error {
//
// 	// load qchan & state from DB
// 	err := nd.ReloadQchanState(qc)
// 	if err != nil {
